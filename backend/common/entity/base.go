...
type BaseRecordField struct {
	CreatorId string `json:"creatorId" gorm:"column:creator_id;comment:创建者id"`
	UpdaterId string `json:"updaterId" gorm:"column:updater_id;comment:更新者id"`
	DeleterId string `json:"deleterId" gorm:"column:deleter_id;comment:删除者id"`
}
