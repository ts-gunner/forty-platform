...
(
  ...
  DEFAULT CHARSET = utf8mb4 COMMENT = 'Agent分类表';
...
(
  ...
  DEFAULT CHARSET = utf8mb4
  COLLATE = utf8mb4_unicode_ci COMMENT = '对话消息记录表';
...
(
  ...
  DEFAULT CHARSET = utf8mb4
  COLLATE = utf8mb4_unicode_ci COMMENT = '问题示例表';
-- 入库算法调用记录表
...
(
  ...
  DEFAULT CHARSET = utf8mb4 COMMENT ='入库算法调用记录表';
...
(
  ...
  DEFAULT CHARSET = utf8mb4
  COLLATE = utf8mb4_unicode_ci COMMENT = '文章详情表';
...
(
  ...
  DEFAULT CHARSET = utf8mb4
  COLLATE = utf8mb4_unicode_ci COMMENT = '文件夹管理表';
...
(
  ...
  DEFAULT CHARSET = utf8mb4
  COLLATE = utf8mb4_unicode_ci COMMENT = '资源素材表';
...
(
  ...
  DEFAULT CHARSET = utf8mb4
  COLLATE = utf8mb4_unicode_ci COMMENT = '审计表';
...
(
  ...
  DEFAULT CHARSET = utf8mb4
  COLLATE = utf8mb4_unicode_ci COMMENT = '用户行为埋点表';
