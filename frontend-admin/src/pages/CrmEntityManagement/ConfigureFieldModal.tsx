    ...
    <Modal
      title={
        <div className="flex items-center gap-2">
          <span>创建客户实体字段</span>
          <span className="flex items-center gap-1 p-2 border rounded-xl text-xs hover:bg-gray-200 cursor-pointer" 
          onClick={resetEntityValue}><RefreshCw className="h-4 w-4"/>重置</span>
        </div>
      }
      open={modalOpen}
      closable={false}
