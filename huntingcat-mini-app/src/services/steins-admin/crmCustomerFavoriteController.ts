...
/** 添加客户信息收藏 POST /crm/favorite/add */
...
export async function checkCustomerFavorite(
  ...
  return request<API.ApiResultBool>("/crm/favorite/check", {
    method: "GET",
    params: {
      ...params,
    },
...
export async function getCustomerFavoriteList(
  ...
  return request<API.ApiResultResponsePageResultCrmCrmCustomerFavoriteVo>(
    "/crm/favorite/list",
    {
      method: "GET",
      params: {
...
/** 取消客户信息收藏 POST /crm/favorite/remove */
